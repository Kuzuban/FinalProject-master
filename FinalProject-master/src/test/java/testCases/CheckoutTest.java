...
public class CheckoutTest extends BasePage {
    ...
    public void Checkout() throws InterruptedException {
        ...
        String elem;
        elem = driver.findElement(By.cssSelector("#root > div > div:nth-child(2) > div > div > div > div > h1")).getAttribute("innerHTML");

        Assert.assertTrue(elem.contains("Your information"));
