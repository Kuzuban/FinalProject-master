...
public class AddTenProductsToCartIconTest extends BasePage {

    @Test
    public void AddTenProductsToCartIcon() throws InterruptedException {
        ...
        String elem;
        elem = driver.findElement(By.cssSelector("#responsive-navbar-nav > div:nth-child(2) > span > a:nth-child(1) > span")).getAttribute("innerHTML");
